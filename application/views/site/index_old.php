<div id="banner" class="banner">
    ...
    <!-- section start -->
    <!-- ================ -->
    <div class="space" id="latest_search_report_space"></div>
    <div class="space"></div>

    

    <h1 id="latest_search_report" class="title text-center"><?php echo $this->lang->line("recent health check report"); ?></h1>
    ...
    <div class="container">
        ...
        <div class="row" >  
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 <?php if($this->is_ad_enabled && ($this->is_ad_enabled2 || $this->is_ad_enabled3)) echo ""; else echo "col-md-offset-2 col-lg-offset-2";?>">
                <h3 class='text-center cover-height'><?php echo $this->lang->line("site health report"); ?></h3><br>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 <?php if($this->is_ad_enabled && $this->is_ad_enabled4) echo ""; else echo "col-md-offset-2 col-lg-offset-2";?>">
                <h3 class='text-center cover-height'><?php echo $this->lang->line("comparitive health report"); ?></h3><br/>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover data-table">
                    <tr>
                        <th class='text-center'><?php echo $this->lang->line("sl"); ?></th>

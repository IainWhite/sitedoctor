...
<?php echo "<div style='font-size:20px !important;' class='text-center alert alert-".$warning_class2."'><b>".$this->config->item('product_short_name')."</b> ".$this->lang->line("found")." <b>".$warning_count2."</b> ".$this->lang->line("major issues")."</div>"; ?>
<div class="row">
<div class="col-xs-12">	

	<?php if($load_css_js!=1) {?>
		<p style='text-align: center;position: relative'>
			<input type="text" class="dial knob" data-readonly="true" value="<?php echo $site_info2[0]["overall_score"]; ?>" data-width="120" data-height="120" data-fgColor="#39CCCC" data-thickness=".1">
	...
	<div class="col-xs-12">
		<div style="border:1px solid #0073B7;border-bottom:2px solid #0073B7;padding: 10px" class="info-box">
				...
				<span class="info-box-number"><?php echo $site_info2[0]["overall_score"]; ?></span>
		</div>
	</div>
	<?php } ?>
...
<div class="row">
	<div class="col-xs-12">				
		...
		<div class="box box-<?php echo $class;?>">
			...
			<div class="box-body chart-responsive minus">
				<?php echo $short_recommendation; ?>
				<?php if($check=="1") echo "<br><a href='".$site_info2[0]["sitemap_location"]."' target='_BLANK'>Sitemap Location</a>";else echo "<br/>";?>
				<br/><br/>
				<a  class="recommendation_link" title="<?php echo $item; ?> : <?php echo $recommendation_word; ?>"> <i class="fa fa-book"></i> <b><?php echo $recommendation_word; ?></b></a>
				<div class="recommendation well"><?php echo $long_recommendation; ?></div>
...
<div class="row">
	<div class="col-xs-12">				
		...
		$class="blue-dark";
		$status="info-circle";	
		$alexa_rank_array = json_decode($site_info2[0]['alexa_rank'], true);	
		?>
...
<div class="row">
	<div class="col-xs-12">				
		...
		$class="blue-dark";
		$status="info-circle";	
		$domain_ip_info = json_decode($site_info2[0]['domain_ip_info'], true);	
		?>
				...
				<div class="row">							
					<div class="col-xs-12">
						...
						if(is_numeric($check) && $check>0)
						{
							...
							$status="remove";	
							$short_recommendation=$this->lang->line('Compressing resources with gzip or deflate can reduce the number of bytes sent over the network.').'
							<br><a target="_blank" href="https://developers.google.com/speed/docs/insights/EnableCompression">Enable compression</a> '.$this->lang->line('for the following resources to reduce their transfer size by').' <b>'.$size_compressable.' ( '.$percent_compressable.$this->lang->line('reduction').' )</b>.';

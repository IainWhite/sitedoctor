	...
	<div class="container-fluid boss-container">
		<?php if($load_css_js!=1) {?>
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-lg-4 col-md-4 share-sibing text-center">
		...
		<div class="row" style='padding-top: 20px'>
			<div class="col-xs-12 <?php if($is_pdf==0) echo "col-md-6" ?>">
				<?php include("application/views/site/report.php"); ?>
			</div>
			<div class="col-xs-12 <?php if($is_pdf==0) echo "col-md-6" ?>">
